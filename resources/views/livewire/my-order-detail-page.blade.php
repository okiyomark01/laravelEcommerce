    ...
    <div class="md:w-3/4">
          ...
          <tbody>
            ...
            @foreach($order_items as $item)
              <tr wire:key="{{ $item->id }}">
                ...
                <td class="py-4">
                  {{ Number::currency($item->unit_amount, 'KSH') }}
                </td>
                <td class="py-4">
      ...
      <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
        ...
        <div class="flex justify-between items-center">
          <div>
            <p>{{ $address->city }}, {{ $address->street_address }}, {{ $address->estate }}, {{ $address->zip_code }}</p>
          </div>
          <div>
    ...
    <div class="md:w-1/4">
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="flex justify-between mb-2">
          <span>Subtotal</span>
          <span>{{ Number::currency($item->order->grand_total, 'KSH') }}</span>
        </div>
        <div class="flex justify-between mb-2">
          <span>Taxes</span>
